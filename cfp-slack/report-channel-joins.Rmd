...
1. All new users are sent to project-ideas, but its last activity was Nov 17th, 2018.
   Is there a way to get activity there (or replace it w/ a different channel?).
2. How many people physically showed up for the last Philly 101? I'll be curious to see what proportion from the 101 join the slack channel each month!